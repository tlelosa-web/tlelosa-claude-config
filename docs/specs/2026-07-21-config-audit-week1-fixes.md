...
> **Status (2026-08-08):** historical spec, recovered from an unmerged
> branch. Its three fixes landed on 2026-08-08 rather than in July, and the
> version numbers it names were superseded in the meantime — the template
> went to v3.4 (not v3.3), `dcoe-roster` to 3.5.0 (not 3.4.0), and CORE to
> 1.3 (not 1.1). See `docs/specs/2026-08-08-branch-triage-verdicts.md`.
